...
class Player:
    ...
    def play(self, dealerCard):
        ...
        if playerCard < dealerCard:
            ...
            self.pot -= gameStake
            message = ' lost this hand.'
            message2 = " was beat by the Dealer's "
            return [message, playerCard, message2]
        else:
            # [INCREMENT THE PLAYER'S POT, AND RETURN A MESSAGE]
            self.pot += gameStake
            message = ' won this hand.'
            message2 = " beat the Dealer's "
            return [message, playerCard, message2]
...
def playHand(players):
    ...
    for player in players:
        ...
        print 'Player '+ str(player.returnID()) + result[0] + ' Their ' + str(result[1]) + result[2] + str(dealerCard) + '.'
